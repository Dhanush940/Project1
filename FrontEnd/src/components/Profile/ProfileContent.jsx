            ...
            <form onSubmit={handleSubmit} aria-required={true}>
              <div className="w-full 800px:flex block pb-3">
                <div className=" w-[100%] 800px:w-[50%]">
                  <label htmlFor="1" className="block pb-2">
                    Full Name
                  </label>
                  <input
                    type="text"
                ...
                <div className=" w-[100%] 800px:w-[50%]">
                  <label htmlFor="2" className="block pb-2">
                    Email Address
                  </label>
                  <input
                    type="text"
...
const ChangePassword = () => {
  ...
  return (
    <div className="w-full px-5">
      <h1 className="block text-[25px] text-center font-[600] text-[rgba(0,0,0,0.73)] pb-2">
        Change Password
      </h1>
      <div className="w-full">
        <form
